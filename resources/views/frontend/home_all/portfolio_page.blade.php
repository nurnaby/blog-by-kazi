<section class="portfolio">
    ...
    <div class="tab-content" id="portfolioTabContent">
        ...
        @php
            $portfolios = App\Models\protfolio::latest()->get();
        @endphp
                            ...
                            @foreach ($portfolios as $portfolio)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ asset($portfolio->protfolio_image) }}" alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                        <span>{{ $portfolio->protfolio_name }}</span>
                                        <h4 class="title"><a
                                                href="portfolio-details.html">{{ $portfolio->protfolio_title }}</a></h4>
