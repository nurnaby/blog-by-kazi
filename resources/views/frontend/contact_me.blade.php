...
<main>
    ...
    <div class="contact-area">
        <div class="container">
            <form action="{{ route('store.contcat') }}" class="contact__form" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <textarea name="message" id="message" placeholder="Enter your massage*" name="message" required></textarea>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="contact__info">
                        <div class="contact__info__icon">
                            <img src="{{ asset('front_end/assets/img/icons/contact_icon01.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="contact__info">
                        <div class="contact__info__icon">
                            <img src="{{ asset('front_end/assets/img/icons/contact_icon02.png') }}" alt="">
                        </div>
                        <div class="contact__info__content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="contact__info">
                        <div class="contact__info__icon">
                            <img src="{{ asset('front_end/assets/img/icons/contact_icon03.png') }}" alt="">
                        </div>
                        <div class="contact__info__content">
